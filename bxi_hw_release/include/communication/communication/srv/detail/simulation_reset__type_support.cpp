...
{
  new (message_memory) communication::srv::SimulationReset_Request(_init);
}

void SimulationReset_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<communication::srv::SimulationReset_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SimulationReset_Request_message_member_array[3] = {
  {
    ...
    offsetof(communication::srv::SimulationReset_Request, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(communication::srv::SimulationReset_Request, base_pose),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(communication::srv::SimulationReset_Request, joint_state),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SimulationReset_Request_message_members = {
  ...
  3,  // number of fields
  sizeof(communication::srv::SimulationReset_Request),
...
{
  return &::communication::srv::rosidl_typesupport_introspection_cpp::SimulationReset_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, communication, srv, SimulationReset_Request)() {
  return &::communication::srv::rosidl_typesupport_introspection_cpp::SimulationReset_Request_message_type_support_handle;
}
...
void SimulationReset_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) communication::srv::SimulationReset_Response(_init);
}

void SimulationReset_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<communication::srv::SimulationReset_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SimulationReset_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(communication::srv::SimulationReset_Response, is_success),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SimulationReset_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(communication::srv::SimulationReset_Response),
...
{
  return &::communication::srv::rosidl_typesupport_introspection_cpp::SimulationReset_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, communication, srv, SimulationReset_Response)() {
  return &::communication::srv::rosidl_typesupport_introspection_cpp::SimulationReset_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers SimulationReset_service_members = {
  ...
  // see get_service_type_support_handle<communication::srv::SimulationReset>()
...
get_service_type_support_handle<communication::srv::SimulationReset>()
{
  ...
  auto service_type_support =
    &::communication::srv::rosidl_typesupport_introspection_cpp::SimulationReset_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, communication, srv, SimulationReset)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<communication::srv::SimulationReset>();
}
