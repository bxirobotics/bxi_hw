...
{
  new (message_memory) communication::srv::GaitSwitch_Request(_init);
}

void GaitSwitch_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<communication::srv::GaitSwitch_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember GaitSwitch_Request_message_member_array[2] = {
  {
    ...
    offsetof(communication::srv::GaitSwitch_Request, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(communication::srv::GaitSwitch_Request, gait_name),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers GaitSwitch_Request_message_members = {
  ...
  2,  // number of fields
  sizeof(communication::srv::GaitSwitch_Request),
...
{
  return &::communication::srv::rosidl_typesupport_introspection_cpp::GaitSwitch_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, communication, srv, GaitSwitch_Request)() {
  return &::communication::srv::rosidl_typesupport_introspection_cpp::GaitSwitch_Request_message_type_support_handle;
}
...
void GaitSwitch_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) communication::srv::GaitSwitch_Response(_init);
}

void GaitSwitch_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<communication::srv::GaitSwitch_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember GaitSwitch_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(communication::srv::GaitSwitch_Response, is_success),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers GaitSwitch_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(communication::srv::GaitSwitch_Response),
...
{
  return &::communication::srv::rosidl_typesupport_introspection_cpp::GaitSwitch_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, communication, srv, GaitSwitch_Response)() {
  return &::communication::srv::rosidl_typesupport_introspection_cpp::GaitSwitch_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers GaitSwitch_service_members = {
  ...
  // see get_service_type_support_handle<communication::srv::GaitSwitch>()
...
get_service_type_support_handle<communication::srv::GaitSwitch>()
{
  ...
  auto service_type_support =
    &::communication::srv::rosidl_typesupport_introspection_cpp::GaitSwitch_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, communication, srv, GaitSwitch)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<communication::srv::GaitSwitch>();
}
