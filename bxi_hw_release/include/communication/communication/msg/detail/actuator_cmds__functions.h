...
#ifndef COMMUNICATION__MSG__DETAIL__ACTUATOR_CMDS__FUNCTIONS_H_
#define COMMUNICATION__MSG__DETAIL__ACTUATOR_CMDS__FUNCTIONS_H_
 ...
 * calls
 * communication__msg__ActuatorCmds__init().
...
/**
 * It calls
 * communication__msg__ActuatorCmds__fini()
 ...
 * communication__msg__ActuatorCmds__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * communication__msg__ActuatorCmds__Sequence__fini()
 * on the array,
...
#endif  // COMMUNICATION__MSG__DETAIL__ACTUATOR_CMDS__FUNCTIONS_H_
