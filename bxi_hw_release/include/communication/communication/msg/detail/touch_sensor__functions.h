...
#ifndef COMMUNICATION__MSG__DETAIL__TOUCH_SENSOR__FUNCTIONS_H_
#define COMMUNICATION__MSG__DETAIL__TOUCH_SENSOR__FUNCTIONS_H_
 ...
 * calls
 * communication__msg__TouchSensor__init().
...
/**
 * It calls
 * communication__msg__TouchSensor__fini()
 ...
 * communication__msg__TouchSensor__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * communication__msg__TouchSensor__Sequence__fini()
 * on the array,
...
#endif  // COMMUNICATION__MSG__DETAIL__TOUCH_SENSOR__FUNCTIONS_H_
